...
\href{https://harzing.com/resources/publish-or-perish/tutorial/metrics/h-and-g-index}{G-index}: 46; \href{https://harzing.com/resources/publish-or-perish/tutorial/metrics/h-and-g-index}{H-index: 19}.
...
Convenor, Political Psychology Specialist Group, PSA  \hfill {2019\,--}
	\begin{innerlist}
		\item[] Co-organized 2nd (2-day), 3rd (5-day), \& 4th (4-day) Conferences
	\end{innerlist}
...
\emph{Current PhD Students}
	\begin{innerlist}
		\item[-] Martyna Kosciuszko (\href{https://www.ukri.org/councils/esrc/career-and-skills-development/centres-for-doctoral-training/}{SOC-B CDT})
	\end{innerlist}
...
\emph{Research Methods}
    \begin{innerlist}
 		...
 		\item[] Data Science Modelling (Using R) (UG)
    	        	\begin{innerlist}
        		    	\item[] [SP22]
        		    \end{innerlist}    
